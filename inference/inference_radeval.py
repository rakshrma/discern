...
from call_llm import _unload_hf_pipeline, _is_db
import pandas as pd
import os
...
REPORT_PATH           = "../data/radevalx/radevalx_report.csv"
OUTPUT_DIR            = "../data/radevalx/"
...
def evaluate_rexval(model: str, output_path: str):
    ...
    for row in rexval_report_pairs.itertuples():
        ...
        print(f"Evaluating study {row.study_id}")
        try:
            result = run_evaluation(
                report_text=row.ground_truth,
